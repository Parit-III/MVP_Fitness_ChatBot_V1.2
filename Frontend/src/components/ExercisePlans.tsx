    ...
    exercises: [
      ...
      },
      {
        ...
        instructions: [
          ...
          'Swing rope over head and under feet',
          'Jump just high enough to clear rope',
          'Land softly on balls of feet'
        ],
        tips: [
          'Use wrists, not arms, to turn rope',
          'Keep jumps small',
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        reps: '12-15',
        calories: 45,
        description: 'A challenging exercise that targets lower abs and hip flexors.',
        instructions: [
      ...
      },
      {
        ...
        duration: '30 sec',
        calories: 45,
        description: 'An isometric exercise that strengthens obliques and lateral core stability.',
        instructions: [
